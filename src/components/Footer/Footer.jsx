            ...
            <Row className="text-center">
              <Col lg={4} md={6} sm={12}>
                ...
                <div className="pages-links">
                  <p>
                    <FontAwesomeIcon icon={faPhoneSquareAlt} /> +970(4)888-8888{" "}
                  </p>
                  <p>
                    <FontAwesomeIcon icon={faEnvelope} />
                    <a href="mailto:email@examole.com">email@example.com</a>
                  </p>
                  <p>
              ...
              <Col lg={4} md={6} sm={12}>
                <h2 className="my-5 footerTitle">Privacy policy</h2>
            ...
            <Row>
              <Col lg={12} md={12} sm={12}>
                <p className="text-center text-white mt-5 mb-0">
                  All right reserved by <a href="#">Your Website</a>
                </p>
              </Col>
            </Row>
          </Container>
